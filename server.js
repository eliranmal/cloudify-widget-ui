...
app.get('/backend/user/widgets/:widgetId/status/:executionId', controllers.widgets.getStatus );
app.get('/backend/user/widgets/:widgetId/output/:executionId', controllers.widgets.getOutput);
